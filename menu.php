        ...
        <div class="menu-right-part">
            <nav id="header-main-menu" class="big-menu">
                <ul class="main-menu sm sm-clean">
                    ...
                    <li class="text-uppercase"><a href="/2022/<?php echo $P1L_23; ?>/"><?php echo $P1_23; ?></a></li>
                    <li class="text-uppercase"><a href="/2022/<?php echo $P2_23; ?>/"><?php echo $P2_23; ?></a></li>
                    <li class="text-uppercase"><a href="/2022/<?php echo $P3_23; ?>/"><?php echo $P3_23; ?></a></li>
                    <li class="text-uppercase"><a href="/2022/<?php echo $P4_23; ?>/"><?php echo $P4_23; ?></a></li>
                    <hr>
                </ul>
                <ul class="main-menu sm sm-clean">
