                ...
                <div class="entry-content">
                    ...
                    <div class="content-970 center-relative">
                        <div class="story-item-info">
                            ...
                            <div class="single-photo"><img src="/2024/images/<?php echo $FirstName; ?>-3.jpg" /></div>
                        </div>
                        <div class="content-wrapper">
                            <?php include ('' . $FirstName .'.php'); ?>
                        </div>
                        <div class="clear"></div>
                        <p class="text-end fw-light fst-italic mt-2">Written by <strong>Meli Slater</strong></p>
                    </div>
                </div>
                <div class="clear"></div>
            </div>
