    ...
    <?php include 'menu.php'; ?>
        ...
        <div id="content" class="site-content">
            <ul class="grid" id="story">
                ...
                <li class="grid-item element-item quote-item animate show-it">
                    "I ask is this Missoula in America? She said yes. Now I can’t leave here. I came to Missoula in my mind, and if that’s Missoula I will stay here." - Paul
                </li>
                <li class="grid-item element-item animate show-it">
                    <div class="item-wrapper">
                        <a href="/nereyda/">
