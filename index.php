...
<html lang="en-US">
  ...
  ?>
    ...
    <?php include 'menu.php'; ?>
        ...
        <div id="content" class="site-content grid text-start lh-base" style="width:970px;">
            <h2>Where do you call home?</h2>
            ...
            <div class="row row-cols-1 row-cols-md-2 g-4">
                <div class="col">
                    ...
                    <img src="/2021/images/charly-card.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card text-bg-dark">
                    <img src="/2022/images/participant1-card-1.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
