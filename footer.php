    ...
    <div class="footer-content content-1140 center-relative">
        <div class="footer-logo">
            <a href="http://softlandingmissoula.org">
                <img src="/images/SLM_Logo.png" alt="SML Logo">
            </a>
        </div>
       <ul id="footer-sidebar">
            <li class="widget widget_text">
                <h4 class="widgettitle">Participate in STORIES OF HOME</h4>
                <div class="textwidget">
                <p>Are you an immigrant or refugee who would like to share your story of finding a home in Missoula?</p>
                    <p>Let us know by <a href="https://docs.google.com/forms/d/e/1FAIpQLSfZ8yE0skOw67MFjlWPAKeSf6ISbLvTi4jPFbFYf0umHKZhvw/viewform" target="_blank">filling out a short survey.</a></p>
                </div>
            </li>
