...
//Show-Hide header sidebar
    ...
    //Fix for story/gallery item text
    jQuery('.story-text-holder').each(function () {
        jQuery(this).find('.story-info').css('margin-top', (jQuery(this).innerHeight() - jQuery(this).find('.story-info').innerHeight()) * 0.5);
    });
...
var storyLoadMore = function (e) {
    jQuery('.more-posts-story').on("click", function () {
        jQuery('#story').find(".hidden").slice(0,4).removeClass("hidden").addClass("animate loaded");
        jQuery('.story-text-holder').each(function () {
            jQuery(this).find('.story-info').css('margin-top', (jQuery(this).innerHeight() - jQuery(this).find('.story-info').innerHeight()) * 0.5);
        });
        animateElement();
        if (!jQuery('#story').find(".hidden").length)
        {
            jQuery('.more-posts-story').hide();
        }
    });
};
